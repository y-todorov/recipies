        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
					...
					<asp:DynamicField DataField="ContactTitle" HeaderText="ContactTitle"/>
					...
					<asp:DynamicField DataField="Fax" HeaderText="Fax"/>
					<asp:DynamicField DataField="HomePage" HeaderText="HomePage"/>
					<asp:DynamicField DataField="Products" HeaderText="Products"/>
				</Columns>
