<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="DynamicApplicationWebApplication.Suppliers.List" %>
			...
			<dynamic:DynamicRadGrid ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <MasterTableView>
                    <Columns>
						...
						<telerik:GridTemplateColumn HeaderText="ContactName">
							<ItemTemplate>
								<asp:DynamicControl runat="server" DataField="ContactName"/>
							</ItemTemplate>
						</telerik:GridTemplateColumn>
						<telerik:GridTemplateColumn HeaderText="ContactTitle">
							<ItemTemplate>
						...
						<telerik:GridTemplateColumn HeaderText="Fax">
							<ItemTemplate>
								<asp:DynamicControl runat="server" DataField="Fax"/>
							</ItemTemplate>
						</telerik:GridTemplateColumn>
						<telerik:GridTemplateColumn HeaderText="HomePage">
							<ItemTemplate>
								<asp:DynamicControl runat="server" DataField="HomePage"/>
							</ItemTemplate>
						</telerik:GridTemplateColumn>
						<telerik:GridTemplateColumn HeaderText="Products">
							<ItemTemplate>
								<asp:DynamicControl runat="server" DataField="Products"/>
							</ItemTemplate>
						</telerik:GridTemplateColumn>
                    </Columns>
                </MasterTableView>
