<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="DynamicApplicationWebApplication.XProducts.List" %>
			...
			<dynamic:DynamicRadGrid ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <MasterTableView>
                    <Columns>
						...
						<telerik:GridTemplateColumn HeaderText="XUnit">
							<ItemTemplate>
								<asp:DynamicControl runat="server" DataField="XUnit"/>
							</ItemTemplate>
						</telerik:GridTemplateColumn>
						<telerik:GridTemplateColumn HeaderText="XSupplier">
							<ItemTemplate>
								<asp:DynamicControl runat="server" DataField="XSupplier"/>
							</ItemTemplate>
						</telerik:GridTemplateColumn>
						<telerik:GridTemplateColumn HeaderText="XCategory">
							<ItemTemplate>
								<asp:DynamicControl runat="server" DataField="XCategory"/>
							</ItemTemplate>
						</telerik:GridTemplateColumn>
                    </Columns>
                </MasterTableView>
