        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
					...
					<asp:DynamicField DataField="XUnit" HeaderText="XUnit"/>
					<asp:DynamicField DataField="XSupplier" HeaderText="XSupplier"/>
					<asp:DynamicField DataField="XCategory" HeaderText="XCategory"/>
				</Columns>
