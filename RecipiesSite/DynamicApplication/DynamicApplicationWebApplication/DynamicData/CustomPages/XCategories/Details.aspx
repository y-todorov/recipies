<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="Details.aspx.cs" Inherits="DynamicApplicationWebApplication.XCategories.Details" %>
            ...
            <asp:FormView runat="server" ID="FormView1" DataSourceID="DetailsDataSource" OnItemDeleted="FormView1_ItemDeleted" RenderOuterTable="false">
                <ItemTemplate>
                    <table id="detailsTable" class="DDDetailsTable" cellpadding="6">
						...
						<tr class="td">
							<td><asp:Label runat="server" Text="XProducts" /></td>
							<td><asp:DynamicControl runat="server" DataField="XProducts" OnInit="DynamicControl_Init" /></td>
						</tr>
